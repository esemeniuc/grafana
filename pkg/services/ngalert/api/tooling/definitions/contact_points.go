...
type OnCallIntegration struct {
	...
	MaxAlerts                *int    `json:"maxAlerts,omitempty" yaml:"maxAlerts,omitempty" hcl:"max_alerts"`
...
type PushoverIntegration struct {
	...
	AlertingPriority *int    `json:"priority,omitempty" yaml:"priority,omitempty" hcl:"priority"`
	OKPriority       *int    `json:"okPriority,omitempty" yaml:"okPriority,omitempty" hcl:"ok_priority"`
	Retry            *int    `json:"retry,omitempty" yaml:"retry,omitempty" hcl:"retry"`
	Expire           *int    `json:"expire,omitempty" yaml:"expire,omitempty" hcl:"expire"`
