...
func (s *Storage) Create(ctx context.Context, key string, obj runtime.Object, out runtime.Object, ttl uint64) error {
	...
	*/
	...
	e, err := resourceToEntity(key, uObj)
	if err != nil {
		return err
	}
...
func (s *Storage) GetList(ctx context.Context, key string, opts storage.ListOptions, listObj runtime.Object) error {
	...
	u, ok := listObj.(*unstructured.UnstructuredList)
	if !ok {
		return apierrors.NewInternalError(fmt.Errorf("unexpected object type: %T", listObj))
	}
	...
	for _, r := range rsp.Results {
		...
		u.Items = append(u.Items, *res.(*unstructured.Unstructured))
	}
