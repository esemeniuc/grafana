...
require (
	...
	k8s.io/apimachinery v0.28.2 // @grafana/grafana-app-platform-squad
	k8s.io/apiserver v0.28.2 // @grafana/grafana-app-platform-squad
	k8s.io/client-go v0.28.2 // @grafana/grafana-app-platform-squad
